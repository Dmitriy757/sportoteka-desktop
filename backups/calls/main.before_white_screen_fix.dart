...
Future<void> main() async {
  ...
  // PushService должен существовать ДО регистрации native bridge.
  // Его конструктор устанавливает IosNativeCallBridge.onAccepted.
  // Иначе очень быстрый Accept может прийти раньше callback.
  if (Platform.isIOS) {
