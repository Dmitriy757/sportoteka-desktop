          ...
          return Padding(
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: active ? _A.accentSoft : Colors.transparent,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Text(
                  tabs[i],
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFFEAF7EF), borderRadius: BorderRadius.circular(8)),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ChoiceChip(
        ...
        labelStyle: TextStyle(color: selected ? _A.green : _A.mutedColor, fontWeight: FontWeight.w700, fontSize: 11.8),
  ...
  Widget build(BuildContext context) {
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        ...
        textStyle: AppTypography.actionStrong(),
        side: BorderSide.none,
...
class _A {
  ...
  static const Color cardSoft = Color(0xFFF7F8F7);
