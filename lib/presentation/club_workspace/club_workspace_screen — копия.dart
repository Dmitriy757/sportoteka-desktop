  ...
  ThemeData _workspaceTheme(BuildContext context) {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: base.inputDecorationTheme.copyWith(
        labelStyle: AppTypography.formLabel(color: _C.muted),
        hintStyle: AppTypography.formHint(color: _C.lightMuted),
      ),
    );
  }
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: AppTypography.menuTitle(color: accent),
                    ),
                    const SizedBox(height: 2),
                    Text(
                      ...
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: AppTypography.menuSubtitle(color: const Color(0xFF667085)),
                    ),
                  ],
                ),
              ),
  ...
  Widget _sectionTitle(String title) {
    return Padding(
      ...
      child: Text(
        ...
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
        style: AppTypography.menuGroup(color: const Color(0xFF98A2B3)),
      ),
    );
  }
