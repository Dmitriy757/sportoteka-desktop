...
///
/// Рабочий экран всегда занимает всю доступную область. Помощник может
/// вызываться либо собственной компактной кнопкой, либо внешней кнопкой
/// Workspace/Dock через [onToggle]. В Workspace плавающий launcher отключается,
/// чтобы не перекрывать окна и рабочие элементы.
