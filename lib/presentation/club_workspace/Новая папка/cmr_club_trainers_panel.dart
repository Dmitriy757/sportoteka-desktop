...
class _CmrColors {
  ...
  static const Color graphiteButton = Color(0xFF333941);
  static const Color graphiteButtonHover = Color(0xFF4B5563);
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: _CmrColors.graphiteButton,
        ...
        child: Opacity(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(icon, color: _CmrColors.graphiteButtonHover, size: 16),
                const SizedBox(width: 6),
          ...
          child: SafeArea(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _CmrColors.line),
                boxShadow: [BoxShadow(color: Colors.black.withOpacity(.12), blurRadius: 28, offset: const Offset(-12, 0))],
              ),
...
class _TrainerEditSideHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          _CmrRoundIcon(icon: Icons.tune_rounded, color: _CmrColors.graphiteButtonHover, size: 38),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Material(
            ...
            child: InkWell(
              ...
              child: const SizedBox(
                width: 34,
                height: 34,
                child: Icon(Icons.close_rounded, size: 17, color: _CmrColors.muted),
              ),
            ),
          ),
        ],
        ...
        child: Opacity(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(icon, size: 16, color: _CmrColors.muted),
                const SizedBox(width: 6),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                Text(title, style: const TextStyle(color: Colors.white, fontSize: 12.2, fontWeight: FontWeight.w500)),
              ],
            ),
          ),
        ),
      ...
      child: Row(
        children: [
          _ModalActionButton(
            ...
            label: 'Сообщение',
            color: _CmrColors.graphiteButtonHover,
            onTap: onMessage,
          ),
          const SizedBox(width: 8),
          _ModalActionButton(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(color: color, fontSize: 10.8, fontWeight: FontWeight.w500),
                ),
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w500, color: _CmrColors.text),
                ),
              ],
            ),
          ),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Opacity(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: color == _CmrColors.green ? _CmrColors.graphiteButton : color,
              borderRadius: BorderRadius.circular(10),
              border: Border.all(color: color == _CmrColors.green ? _CmrColors.graphiteButtonHover.withOpacity(.22) : color.withOpacity(.25)),
            ),
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                Flexible(child: Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 12.5, fontWeight: FontWeight.w500))),
              ],
            ),
          ),
        ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Главный',
                        style: TextStyle(color: _CmrColors.green, fontSize: 11, fontWeight: FontWeight.w500),
                      ),
                    ],
                  ),
                ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      value,
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: _CmrColors.text),
                    ),
                  ],
                ),
              ),
