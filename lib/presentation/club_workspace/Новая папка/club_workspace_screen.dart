...
class _ClubWorkspaceScreenState extends State<ClubWorkspaceScreen>
  ...
  _WorkspaceWindowState? _workspaceWindowFor(ClubSection section) {
...
class _WorkspaceDock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    final maxWidth = math.min(width - 28, 1180.0);
            ...
            child: Stack(
              ...
              children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: bg,
                    borderRadius: BorderRadius.circular(widget.size >= 50 ? 18 : 16),
                    border: Border.all(color: widget.active ? _C.railText.withOpacity(.22) : _C.borderSoft),
                  ),
                  child: Icon(widget.icon, color: iconColor, size: widget.size >= 50 ? 24 : 22),
                ),
                if (widget.running)
                  Positioned(
                    bottom: 0,
                    child: Container(
                      ...
                      height: 4,
                      decoration: BoxDecoration(
                        color: widget.minimized ? _C.lightMuted : _C.railText,
                        borderRadius: BorderRadius.circular(999),
                      ),
                    ),
                  ),
