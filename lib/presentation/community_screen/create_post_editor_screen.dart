...
class _CreatePostEditorScreenState extends State<CreatePostEditorScreen> {
  ...
  Future<void> _save() async {
    if (_saving) return;
    final isSimpleMobile = (widget.forceSimpleComposer ||
  ...
  Color _softForAccent(Color color) {
    ...
    if (color == const Color(0xFF067A46) || color == const Color(0xFF00A750)) {
                ...
                child: Row(
                  children: [
                    IconButton(
                      tooltip: 'Закрыть',
                      onPressed:
                          _saving ? null : () => _finishEditor(saved: false),
                      icon: Icon(
                        isPhone
  ...
  List<Widget> _buildEditorChildren() {
    return <Widget>[
      ...
      _editorSection(
        ...
        statusText: _title.text.trim().isNotEmpty ? 'Готово' : 'Не заполнено',
        child: TextField(
          controller: _title,
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          _newCoverFile != null || _coverUrl.trim().isNotEmpty
                              ? 'Заменить обложку'
                              : 'Выбрать обложку',
                          style: _editorText(
                            10.5,
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    _showBlockLibrary ? Icons.close_rounded : Icons.add_rounded,
                    size: 15,
                    color: const Color(0xFF067A46),
                  ),
