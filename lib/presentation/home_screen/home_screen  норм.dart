...
Widget _buildWorkspaceCommandCenterSection(
  ...
  print('BUILD COMMAND CENTER');
  print('BUILD COMMAND CENTER recentChats=${_recentChats.length}');
  ...
  return _buildHomeSectionShell(
    title: isClub ? 'Рабочий центр клуба' : 'Рабочий центр команды',
    rightText: 'live',
    margin: margin,
    child: LayoutBuilder(
  ...
  return Column(
    children: [
      Row(
        ...
        children: [
          Expanded(
            child: _buildLastMatchTtdCard(match),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: _buildRecentChatsCard(),
          ),
        ],
      ),
      const SizedBox(height: 10),
      ...
      const SizedBox(height: 10),
      _buildQuickCoachActionsGrid(context),
    ],
  );
}
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [
          _homeDesign.primaryColor.withOpacity(0.12),
          _homeDesign.primaryColor.withOpacity(0.06),
        ],
    ...
    child: Row(
      children: [
        Container(
          ...
          height: 38,
          decoration: BoxDecoration(
            color: _homeDesign.primaryColor.withOpacity(0.14),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Icon(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                _isClubRole
                    ? 'Открыть полный экран управления клубом'
                    : 'Открыть полный экран управления',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: const TextStyle(
                  color: Color(0xFF64748B),
...
Widget _buildWorkspaceTeamPickerSection(
  ...
  if ((!_isCoachRole && !_isClubRole) || source.isEmpty) {
