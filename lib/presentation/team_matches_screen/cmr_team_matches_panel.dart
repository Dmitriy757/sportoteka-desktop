...
Color _matchWinAccent(int index) => _CmrMatchColors.green;

Color _matchWinAccentSoft(int index) => _CmrMatchColors.greenSoft;
...
Widget _buildTabletMatchesWorkspace({
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(
                constraints.maxWidth < 980 ? 18 : 20,
              ),
              boxShadow: [
                BoxShadow(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(
                  width: 1,
                  child: ColoredBox(color: _CmrMatchColors.border),
                ),
                Expanded(
  ...
  Widget _buildMatchesInfoRows(List<Map<String, dynamic>> monthList) {
    ...
    final items = [
      ...
      _MatchKpiData(label: 'День', value: selectedDay == null ? '—' : '${selectedDayMatches.length}', icon: Icons.today_rounded, color: _CmrMatchColors.green, hint: selectedDay == null ? 'не выбран' : _dateRu(selectedDay!)),
      _MatchKpiData(label: 'Впереди', value: '$upcomingCount', icon: Icons.event_available_rounded, color: _CmrMatchColors.green, hint: 'будущие игры'),
      _MatchKpiData(label: 'Архив', value: '$archiveCount', icon: Icons.history_rounded, color: _CmrMatchColors.green, hint: 'прошедшие'),
      _MatchKpiData(label: 'Голы', value: '$goalsFor:$goalsAgainst', icon: Icons.trending_up_rounded, color: _CmrMatchColors.green, hint: 'забито/пропущено'),
      _MatchKpiData(label: 'Баланс', value: balance, icon: Icons.timeline_rounded, color: _CmrMatchColors.green, hint: 'В-Н-П'),
    ];
          ...
          children: [
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _ProfileMetaPill(icon: Icons.fact_check_outlined, text: typeText.isEmpty ? 'Матч' : typeText, color: _CmrMatchColors.green),
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                miniMetric(icon: Icons.insights_rounded, title: 'Готовность', value: '${(readyPercent * 100).round()}%', color: _CmrMatchColors.green),
              ],
            ),
            const SizedBox(height: 12),
            Container(
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.view_agenda_rounded, color: _CmrMatchColors.green, size: 18),
              ),
              const SizedBox(width: 9),
              Expanded(
                child: Column(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _CmrMatchColors.soft,
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: _CmrMatchColors.border.withOpacity(.70), width: .7),
      ),
      child: Row(
        children: [
          Text(
...
class _MatchNextStrip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const accent = _CmrMatchColors.green;
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
      decoration: BoxDecoration(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: _CmrMatchColors.green, size: 13),
          ),
          const SizedBox(width: 7),
          Expanded(
            child: Column(
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(
            icon,
            color: emphasized ? _CmrMatchColors.greenDark : accent,
            size: 18,
          ),
        ),
      ),
