...
class _C {
  ...
  static const greenBorder = CmrVideoColors.greenBorder;
}
  ...
  Widget build(BuildContext context) {
    final content = LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (mobile) {
          return ColoredBox(color: Colors.white, child: leftPane);
        }
    ...
    final page = widget.embedded
        ? content
        : Scaffold(backgroundColor: _C.bg, body: SafeArea(child: content));
    return CmrVideoThemeScope(child: page);
  }
}
