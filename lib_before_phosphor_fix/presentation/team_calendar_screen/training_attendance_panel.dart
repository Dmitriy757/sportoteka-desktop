        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _line.withOpacity(.72), width: .7),
            ),
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: active ? item.color : const Color(0xFFE9ECEA), width: active ? 1.35 : .7),
      ),
      child: Text(
        item.symbol,
        style: TextStyle(fontSize: size * .37, fontWeight: FontWeight.w700, color: active ? item.color : const Color(0xFF8A9099), height: 1),
      ),
    );
  }
}
