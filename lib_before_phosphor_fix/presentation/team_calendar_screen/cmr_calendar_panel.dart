  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _C.soft,
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: _C.line.withOpacity(.70), width: .7),
      ),
      child: Row(
        children: [
          Text(
...
class _InlineEventDetailsPanelState extends State<_InlineEventDetailsPanel> {
  int tab = 0;
  int coachId = 0;
  @override void initState(){super.initState(); _loadCoach();}
        ...
        Expanded(child: !isTrainingLike||tab==0
            ...
            : tab==1
                ...
                : (coachId<=0
                    ...
                    : TrainingRatingSheet(key:ValueKey('rating-${event.id}'),apiBase:_CmrCalendarPanelState.apiBase,teamId:event.teamId,eventId:event.id,coachId:coachId,title:event.title,embedded:true))),
      ]),
    );
  }
