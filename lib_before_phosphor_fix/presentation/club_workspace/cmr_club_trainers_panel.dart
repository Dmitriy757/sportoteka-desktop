            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 34,
                  decoration: BoxDecoration(
                    color: accent ? _CmrColors.greenSoft : Colors.white,
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: Icon(
                    icon,
                    size: 17,
                    color: accent ? _CmrColors.greenDark : _CmrColors.muted,
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(title, style: _CmrText.value(12.4)),
                      const SizedBox(height: 3),
                      Text(
                        subtitle,
                        maxLines: 1,
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.chevron_right_rounded, size: 17, color: color.withOpacity(.65)),
              ],
            ),
          ),
        ),
