          ...
          return Padding(
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                child: Text(item.$2, style: TextStyle(color: active ? _CmrColors.greenDark : _CmrColors.muted, fontSize: 12, fontWeight: FontWeight.w700)),
              ),
            ),
          );
        }).toList(),
...
class _CmrText {
  static TextStyle title(double size) => TextStyle(fontSize: size, fontWeight: FontWeight.w700, color: _CmrColors.black, height: 1.08);
      ...
      child: Opacity(
        ...
        child: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            const SizedBox(width: 8),
            Flexible(child: Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 13))),
          ]),
        ),
      ),
    );
      ...
      child: Opacity(
        ...
        child: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            const SizedBox(width: 8),
            Flexible(child: Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: _CmrColors.black, fontWeight: FontWeight.w700, fontSize: 13))),
          ]),
        ),
      ),
    );
...
class _CmrInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: _CmrColors.text),
...
class _CmrTinyChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Text(text, style: const TextStyle(fontSize: 10.5, fontWeight: FontWeight.w700, color: _CmrColors.muted)),
      );
}
...
class _CmrChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(text, style: TextStyle(fontSize: 11.5, color: color, fontWeight: FontWeight.w700)),
        ]),
      );
}
...
class _CmrActionPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: _CmrColors.bg, borderRadius: BorderRadius.circular(999), border: Border.all(color: _CmrColors.border)),
          child: Row(mainAxisSize: MainAxisSize.min, children: [Icon(icon, size: 16, color: _CmrColors.greenDark), const SizedBox(width: 7), Text(title, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: _CmrColors.black))]),
        ),
      );
}
